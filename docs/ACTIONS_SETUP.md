...
| `components.schemas ... is not an object` | You are using an older or altered schema. MyTerminal 0.1.2 returns a concrete object. Re-import from the running service. |
