...
The `skill` tool in `fork` mode also accepts `forkOptions` that override these fields for the subagent spawned by a skill. See `docs/adr/0010-skill-invoke-tool-v2.md` for the full schema.
