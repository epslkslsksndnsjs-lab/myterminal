...
Paste the block below into the GPT editor's **Instructions** field. It is validated against MyTerminal 0.1.0 and defines the exact semantics of the three Actions operations, audit lifecycle, and MyTerminal session lifecycle.
