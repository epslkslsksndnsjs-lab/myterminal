...
test('stable release metadata and binary installers stay pinned to v0.1.1', () => {
...
test('harness introduction and architecture match v0.1.1 without stale process reports', () => {
